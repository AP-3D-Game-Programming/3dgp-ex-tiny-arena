...
public abstract class Spell : MonoBehaviour
{
    ...
    public int maxPenetrations;     // aantal enemies dat geraakt mag worden
    public bool stopOnWall;        // stopt als je een muur raakt
    public float damageFalloff;      // schade verlies per penetratie
    ...
    //}
    public abstract void PlayTrailFX(Transform stafftTip, Camera cam, Color color);
}
